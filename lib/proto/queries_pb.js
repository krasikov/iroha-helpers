...
proto.iroha.protocol.TxPaginationMeta.prototype.getOptFirstTxHashCase = function () {
  return (
    /** @type {proto.iroha.protocol.TxPaginationMeta.OptFirstTxHashCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.TxPaginationMeta.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.AssetPaginationMeta.prototype.getOptFirstAssetIdCase = function () {
  return (
    /** @type {proto.iroha.protocol.AssetPaginationMeta.OptFirstAssetIdCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.AssetPaginationMeta.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.GetAccountTransactions.prototype.getPaginationMeta = function () {
  return (
    /** @type{?proto.iroha.protocol.TxPaginationMeta} */
...
proto.iroha.protocol.GetAccountAssets.prototype.getPaginationMeta = function () {
  return (
    /** @type{?proto.iroha.protocol.AssetPaginationMeta} */
...
proto.iroha.protocol.AccountDetailPaginationMeta.prototype.getFirstRecordId = function () {
  return (
    /** @type{?proto.iroha.protocol.AccountDetailRecordId} */
...
proto.iroha.protocol.GetAccountDetail.prototype.getOptAccountIdCase = function () {
  return (
    /** @type {proto.iroha.protocol.GetAccountDetail.OptAccountIdCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.GetAccountDetail.oneofGroups_[0])
  );
};
/**
 * @enum {number}
...
proto.iroha.protocol.GetAccountDetail.prototype.getOptKeyCase = function () {
  return (
    /** @type {proto.iroha.protocol.GetAccountDetail.OptKeyCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.GetAccountDetail.oneofGroups_[1])
  );
};
/**
 * @enum {number}
...
proto.iroha.protocol.GetAccountDetail.prototype.getOptWriterCase = function () {
  return (
    /** @type {proto.iroha.protocol.GetAccountDetail.OptWriterCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.GetAccountDetail.oneofGroups_[2])
  );
};
...
proto.iroha.protocol.GetAccountDetail.prototype.getPaginationMeta = function () {
  return (
    /** @type{?proto.iroha.protocol.AccountDetailPaginationMeta} */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.iroha.protocol.GetEngineResponse} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.iroha.protocol.GetEngineResponse}
 */
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.iroha.protocol.GetEngineResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.iroha.protocol.GetEngineResponse}
 */
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.iroha.protocol.GetEngineResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.iroha.protocol.Query.Payload.prototype.getQueryCase = function () {
  return (
    /** @type {proto.iroha.protocol.Query.Payload.QueryCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.Query.Payload.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.Query.Payload.prototype.getMeta = function () {
  return (
    /** @type{?proto.iroha.protocol.QueryPayloadMeta} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetAccount = function () {
  return (
    /** @type{?proto.iroha.protocol.GetAccount} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetSignatories = function () {
  return (
    /** @type{?proto.iroha.protocol.GetSignatories} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetAccountTransactions = function () {
  return (
    /** @type{?proto.iroha.protocol.GetAccountTransactions} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetAccountAssetTransactions = function () {
  return (
    /** @type{?proto.iroha.protocol.GetAccountAssetTransactions} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetTransactions = function () {
  return (
    /** @type{?proto.iroha.protocol.GetTransactions} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetAccountAssets = function () {
  return (
    /** @type{?proto.iroha.protocol.GetAccountAssets} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetAccountDetail = function () {
  return (
    /** @type{?proto.iroha.protocol.GetAccountDetail} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetRoles = function () {
  return (
    /** @type{?proto.iroha.protocol.GetRoles} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetRolePermissions = function () {
  return (
    /** @type{?proto.iroha.protocol.GetRolePermissions} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetAssetInfo = function () {
  return (
    /** @type{?proto.iroha.protocol.GetAssetInfo} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetPendingTransactions = function () {
  return (
    /** @type{?proto.iroha.protocol.GetPendingTransactions} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetBlock = function () {
  return (
    /** @type{?proto.iroha.protocol.GetBlock} */
...
proto.iroha.protocol.Query.Payload.prototype.getGetPeers = function () {
  return (
    /** @type{?proto.iroha.protocol.GetPeers} */
...
/**
 * optional GetEngineResponse get_engine_response = 16;
 * @return {?proto.iroha.protocol.GetEngineResponse}
 */
...
proto.iroha.protocol.Query.Payload.prototype.getGetEngineResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.GetEngineResponse} */
    jspb.Message.getWrapperField(this, proto.iroha.protocol.GetEngineResponse, 16)
  );
};
/** @param {?proto.iroha.protocol.GetEngineResponse|undefined} value */
...
proto.iroha.protocol.Query.prototype.getPayload = function () {
  return (
    /** @type{?proto.iroha.protocol.Query.Payload} */
...
proto.iroha.protocol.Query.prototype.getSignature = function () {
  return (
    /** @type{?proto.iroha.protocol.Signature} */
