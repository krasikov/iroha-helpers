...
goog.exportSymbol('proto.iroha.protocol.GetEngineResponse', null, global);
...
proto.iroha.protocol.GetEngineResponse = function (opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};

goog.inherits(proto.iroha.protocol.GetEngineResponse, jspb.Message);

if (goog.DEBUG && !COMPILED) {
  proto.iroha.protocol.GetEngineResponse.displayName = 'proto.iroha.protocol.GetEngineResponse';
}
...
proto.iroha.protocol.AssetPaginationMeta.prototype.getOptFirstAssetIdCase = function () {
  return jspb.Message.computeOneofCase(this, proto.iroha.protocol.AssetPaginationMeta.oneofGroups_[0]);
};
...
proto.iroha.protocol.AssetPaginationMeta.prototype.setFirstAssetId = function (value) {
  jspb.Message.setOneofField(this, 2, proto.iroha.protocol.AssetPaginationMeta.oneofGroups_[0], value);
};

proto.iroha.protocol.AssetPaginationMeta.prototype.clearFirstAssetId = function () {
  jspb.Message.setOneofField(this, 2, proto.iroha.protocol.AssetPaginationMeta.oneofGroups_[0], undefined);
};
...
proto.iroha.protocol.GetAccountAssets.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, proto.iroha.protocol.AssetPaginationMeta.serializeBinaryToWriter);
  }
};
...
proto.iroha.protocol.GetAccountAssets.prototype.getPaginationMeta = function () {
  return jspb.Message.getWrapperField(this, proto.iroha.protocol.AssetPaginationMeta, 2);
};
...
proto.iroha.protocol.AccountDetailPaginationMeta.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, primitive_pb.AccountDetailRecordId.serializeBinaryToWriter);
  }
};
...
proto.iroha.protocol.AccountDetailPaginationMeta.prototype.getFirstRecordId = function () {
  return jspb.Message.getWrapperField(this, primitive_pb.AccountDetailRecordId, 2);
};
...
proto.iroha.protocol.AccountDetailPaginationMeta.prototype.clearFirstRecordId = function () {
  this.setFirstRecordId(undefined);
};
...
proto.iroha.protocol.GetAccountDetail.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(4, f, proto.iroha.protocol.AccountDetailPaginationMeta.serializeBinaryToWriter);
  }
};
...
proto.iroha.protocol.GetAccountDetail.prototype.getPaginationMeta = function () {
  return jspb.Message.getWrapperField(this, proto.iroha.protocol.AccountDetailPaginationMeta, 4);
};
...
proto.iroha.protocol.GetPendingTransactions.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(1, f, proto.iroha.protocol.TxPaginationMeta.serializeBinaryToWriter);
  }
};

proto.iroha.protocol.GetPendingTransactions.prototype.getPaginationMeta = function () {
  return jspb.Message.getWrapperField(this, proto.iroha.protocol.TxPaginationMeta, 1);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  proto.iroha.protocol.GetEngineResponse.prototype.toObject = function (opt_includeInstance) {
    return proto.iroha.protocol.GetEngineResponse.toObject(opt_includeInstance, this);
  };

  proto.iroha.protocol.GetEngineResponse.toObject = function (includeInstance, msg) {
    var f,
        obj = {
...
proto.iroha.protocol.GetEngineResponse.deserializeBinary = function (bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.iroha.protocol.GetEngineResponse();
  return proto.iroha.protocol.GetEngineResponse.deserializeBinaryFromReader(msg, reader);
};

proto.iroha.protocol.GetEngineResponse.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
...
proto.iroha.protocol.GetEngineResponse.prototype.serializeBinary = function () {
  var writer = new jspb.BinaryWriter();
  proto.iroha.protocol.GetEngineResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};

proto.iroha.protocol.GetEngineResponse.serializeBinaryToWriter = function (message, writer) {
  var f = undefined;
  f = message.getTxHash();
...
proto.iroha.protocol.GetEngineResponse.prototype.getTxHash = function () {
  return jspb.Message.getFieldWithDefault(this, 1, "");
};

proto.iroha.protocol.GetEngineResponse.prototype.setTxHash = function (value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.iroha.protocol.Query.Payload.toObject = function (includeInstance, msg) {
    var f,
      ...
      getEngineResponse: (f = msg.getGetEngineResponse()) && proto.iroha.protocol.GetEngineResponse.toObject(includeInstance, f)
    };
...
proto.iroha.protocol.Query.Payload.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 16:
        var value = new proto.iroha.protocol.GetEngineResponse();
        reader.readMessage(value, proto.iroha.protocol.GetEngineResponse.deserializeBinaryFromReader);
        msg.setGetEngineResponse(value);
        break;
...
proto.iroha.protocol.Query.Payload.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(15, f, proto.iroha.protocol.GetPeers.serializeBinaryToWriter);
  }

  f = message.getGetEngineResponse();

  if (f != null) {
    writer.writeMessage(16, f, proto.iroha.protocol.GetEngineResponse.serializeBinaryToWriter);
  }
};
...
proto.iroha.protocol.Query.Payload.prototype.getGetPeers = function () {
  return jspb.Message.getWrapperField(this, proto.iroha.protocol.GetPeers, 15);
};

proto.iroha.protocol.Query.Payload.prototype.setGetPeers = function (value) {
  jspb.Message.setOneofWrapperField(this, 15, proto.iroha.protocol.Query.Payload.oneofGroups_[0], value);
};

proto.iroha.protocol.Query.Payload.prototype.clearGetPeers = function () {
  this.setGetPeers(undefined);
};
...
proto.iroha.protocol.Query.Payload.prototype.getGetEngineResponse = function () {
  return jspb.Message.getWrapperField(this, proto.iroha.protocol.GetEngineResponse, 16);
};

proto.iroha.protocol.Query.Payload.prototype.setGetEngineResponse = function (value) {
  jspb.Message.setOneofWrapperField(this, 16, proto.iroha.protocol.Query.Payload.oneofGroups_[0], value);
};

proto.iroha.protocol.Query.Payload.prototype.clearGetEngineResponse = function () {
  this.setGetEngineResponse(undefined);
};

proto.iroha.protocol.Query.Payload.prototype.hasGetEngineResponse = function () {
