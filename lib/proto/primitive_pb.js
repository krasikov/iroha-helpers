...
proto.iroha.protocol.Peer.prototype.getCertificateCase = function () {
  return (
    /** @type {proto.iroha.protocol.Peer.CertificateCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.Peer.oneofGroups_[0])
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.iroha.protocol.EngineResponseRecord} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.iroha.protocol.EngineResponseRecord} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.iroha.protocol.EngineResponseRecord}
 */
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.iroha.protocol.EngineResponseRecord} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
/**
 * optional uint64 command_index = 1;
 * @return {number}
 */
