...
proto.iroha.protocol.AccountAssetResponse.prototype.getOptNextAssetIdCase = function () {
  return (
    /** @type {proto.iroha.protocol.AccountAssetResponse.OptNextAssetIdCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.AccountAssetResponse.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.AccountAssetResponse.prototype.getAccountAssetsList = function () {
  return (
    /** @type{!Array<!proto.iroha.protocol.AccountAsset>} */
...
proto.iroha.protocol.AccountResponse.prototype.getAccount = function () {
  return (
    /** @type{?proto.iroha.protocol.Account} */
...
proto.iroha.protocol.AssetResponse.prototype.getAsset = function () {
  return (
    /** @type{?proto.iroha.protocol.Asset} */
...
proto.iroha.protocol.ErrorResponse.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.iroha.protocol.ErrorResponse.Reason} */
        reader.readEnum();
        msg.setReason(value);
        break;
...
proto.iroha.protocol.TransactionsResponse.prototype.getTransactionsList = function () {
  return (
    /** @type{!Array<!proto.iroha.protocol.Transaction>} */
...
proto.iroha.protocol.TransactionsPageResponse.prototype.getNextPageTagCase = function () {
  return (
    /** @type {proto.iroha.protocol.TransactionsPageResponse.NextPageTagCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.TransactionsPageResponse.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.PendingTransactionsPageResponse.prototype.getNextBatchInfo = function () {
  return (
    /** @type{?proto.iroha.protocol.PendingTransactionsPageResponse.BatchInfo} */
...
proto.iroha.protocol.PeersResponse.prototype.getPeersList = function () {
  return (
    /** @type{!Array<!proto.iroha.protocol.Peer>} */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.iroha.protocol.EngineResponse} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.iroha.protocol.EngineResponse}
 */
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.iroha.protocol.EngineResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.iroha.protocol.EngineResponse}
 */
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.iroha.protocol.EngineResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
/**
 * repeated EngineResponseRecord engine_response_records = 1;
 * @return {!Array<!proto.iroha.protocol.EngineResponseRecord>}
 */


proto.iroha.protocol.EngineResponse.prototype.getEngineResponseRecordsList = function () {
  return (
    /** @type{!Array<!proto.iroha.protocol.EngineResponseRecord>} */
    jspb.Message.getRepeatedWrapperField(this, primitive_pb.EngineResponseRecord, 1)
  );
};
/** @param {!Array<!proto.iroha.protocol.EngineResponseRecord>} value */
...
/**
 * @param {!proto.iroha.protocol.EngineResponseRecord=} opt_value
 * @param {number=} opt_index
 * @return {!proto.iroha.protocol.EngineResponseRecord}
 */
...
proto.iroha.protocol.QueryResponse.prototype.getResponseCase = function () {
  return (
    /** @type {proto.iroha.protocol.QueryResponse.ResponseCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.QueryResponse.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.QueryResponse.prototype.getAccountAssetsResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.AccountAssetResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getAccountDetailResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.AccountDetailResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getAccountResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.AccountResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getErrorResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.ErrorResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getSignatoriesResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.SignatoriesResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getTransactionsResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.TransactionsResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getAssetResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.AssetResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getRolesResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.RolesResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getRolePermissionsResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.RolePermissionsResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getTransactionsPageResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.TransactionsPageResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getPendingTransactionsPageResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.PendingTransactionsPageResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getBlockResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.BlockResponse} */
...
proto.iroha.protocol.QueryResponse.prototype.getPeersResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.PeersResponse} */
...
/**
 * optional EngineResponse engine_response = 15;
 * @return {?proto.iroha.protocol.EngineResponse}
 */
...
proto.iroha.protocol.QueryResponse.prototype.getEngineResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.EngineResponse} */
    jspb.Message.getWrapperField(this, proto.iroha.protocol.EngineResponse, 15)
  );
};
/** @param {?proto.iroha.protocol.EngineResponse|undefined} value */
...
proto.iroha.protocol.BlockResponse.prototype.getBlock = function () {
  return (
    /** @type{?proto.iroha.protocol.Block} */
...
proto.iroha.protocol.BlockQueryResponse.prototype.getResponseCase = function () {
  return (
    /** @type {proto.iroha.protocol.BlockQueryResponse.ResponseCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.BlockQueryResponse.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.BlockQueryResponse.prototype.getBlockErrorResponse = function () {
  return (
    /** @type{?proto.iroha.protocol.BlockErrorResponse} */
