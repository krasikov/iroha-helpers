...
proto.iroha.protocol.Transaction.Payload.prototype.getOptionalBatchMetaCase = function () {
  return (
    /** @type {proto.iroha.protocol.Transaction.Payload.OptionalBatchMetaCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.Transaction.Payload.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.Transaction.Payload.BatchMeta.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.iroha.protocol.Transaction.Payload.BatchMeta.BatchType} */
        reader.readEnum();
        msg.setType(value);
        break;
...
proto.iroha.protocol.Transaction.Payload.ReducedPayload.prototype.getCommandsList = function () {
  return (
    /** @type{!Array<!proto.iroha.protocol.Command>} */
...
proto.iroha.protocol.Transaction.Payload.prototype.getReducedPayload = function () {
  return (
    /** @type{?proto.iroha.protocol.Transaction.Payload.ReducedPayload} */
...
proto.iroha.protocol.Transaction.Payload.prototype.getBatch = function () {
  return (
    /** @type{?proto.iroha.protocol.Transaction.Payload.BatchMeta} */
...
proto.iroha.protocol.Transaction.prototype.getPayload = function () {
  return (
    /** @type{?proto.iroha.protocol.Transaction.Payload} */
...
proto.iroha.protocol.Transaction.prototype.getSignaturesList = function () {
  return (
    /** @type{!Array<!proto.iroha.protocol.Signature>} */
