...
proto.iroha.protocol.AddPeer.prototype.getPeer = function () {
  return (
    /** @type{?proto.iroha.protocol.Peer} */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.iroha.protocol.EngineCall} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.iroha.protocol.EngineCall}
 */
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.iroha.protocol.EngineCall} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.iroha.protocol.EngineCall}
 */
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.iroha.protocol.EngineCall} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.iroha.protocol.CreateRole.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        var value =
        /** @type {!Array<!proto.iroha.protocol.RolePermission>} */
...
proto.iroha.protocol.GrantPermission.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        var value =
        /** @type {!proto.iroha.protocol.GrantablePermission} */
        reader.readEnum();
...
proto.iroha.protocol.CompareAndSetAccountDetail.prototype.getOptOldValueCase = function () {
  return (
    /** @type {proto.iroha.protocol.CompareAndSetAccountDetail.OptOldValueCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.CompareAndSetAccountDetail.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.Command.prototype.getCommandCase = function () {
  return (
    /** @type {proto.iroha.protocol.Command.CommandCase} */
    jspb.Message.computeOneofCase(this, proto.iroha.protocol.Command.oneofGroups_[0])
  );
};
...
proto.iroha.protocol.Command.prototype.getAddAssetQuantity = function () {
  return (
    /** @type{?proto.iroha.protocol.AddAssetQuantity} */
...
proto.iroha.protocol.Command.prototype.getAddPeer = function () {
  return (
    /** @type{?proto.iroha.protocol.AddPeer} */
...
proto.iroha.protocol.Command.prototype.getAddSignatory = function () {
  return (
    /** @type{?proto.iroha.protocol.AddSignatory} */
...
/**
 * optional EngineCall engine_call = 19;
 * @return {?proto.iroha.protocol.EngineCall}
 */
...
proto.iroha.protocol.Command.prototype.getEngineCall = function () {
  return (
    /** @type{?proto.iroha.protocol.EngineCall} */
    jspb.Message.getWrapperField(this, proto.iroha.protocol.EngineCall, 19)
  );
};
/** @param {?proto.iroha.protocol.EngineCall|undefined} value */
...
proto.iroha.protocol.Command.prototype.getAppendRole = function () {
  return (
    /** @type{?proto.iroha.protocol.AppendRole} */
...
proto.iroha.protocol.Command.prototype.getCreateAccount = function () {
  return (
    /** @type{?proto.iroha.protocol.CreateAccount} */
...
proto.iroha.protocol.Command.prototype.getCreateAsset = function () {
  return (
    /** @type{?proto.iroha.protocol.CreateAsset} */
...
proto.iroha.protocol.Command.prototype.getCreateDomain = function () {
  return (
    /** @type{?proto.iroha.protocol.CreateDomain} */
...
proto.iroha.protocol.Command.prototype.getCreateRole = function () {
  return (
    /** @type{?proto.iroha.protocol.CreateRole} */
...
proto.iroha.protocol.Command.prototype.getDetachRole = function () {
  return (
    /** @type{?proto.iroha.protocol.DetachRole} */
...
proto.iroha.protocol.Command.prototype.getGrantPermission = function () {
  return (
    /** @type{?proto.iroha.protocol.GrantPermission} */
...
proto.iroha.protocol.Command.prototype.getRemoveSignatory = function () {
  return (
    /** @type{?proto.iroha.protocol.RemoveSignatory} */
...
proto.iroha.protocol.Command.prototype.getRevokePermission = function () {
  return (
    /** @type{?proto.iroha.protocol.RevokePermission} */
...
proto.iroha.protocol.Command.prototype.getSetAccountDetail = function () {
  return (
    /** @type{?proto.iroha.protocol.SetAccountDetail} */
...
proto.iroha.protocol.Command.prototype.getSetAccountQuorum = function () {
  return (
    /** @type{?proto.iroha.protocol.SetAccountQuorum} */
...
proto.iroha.protocol.Command.prototype.getSubtractAssetQuantity = function () {
  return (
    /** @type{?proto.iroha.protocol.SubtractAssetQuantity} */
...
proto.iroha.protocol.Command.prototype.getTransferAsset = function () {
  return (
    /** @type{?proto.iroha.protocol.TransferAsset} */
...
proto.iroha.protocol.Command.prototype.getRemovePeer = function () {
  return (
    /** @type{?proto.iroha.protocol.RemovePeer} */
...
proto.iroha.protocol.Command.prototype.getCompareAndSetAccountDetail = function () {
  return (
    /** @type{?proto.iroha.protocol.CompareAndSetAccountDetail} */
...
/**
 * optional SetSettingValue set_setting_value = 20;
 * @return {?proto.iroha.protocol.SetSettingValue}
 */
...
proto.iroha.protocol.Command.prototype.getSetSettingValue = function () {
  return (
    /** @type{?proto.iroha.protocol.SetSettingValue} */
    jspb.Message.getWrapperField(this, proto.iroha.protocol.SetSettingValue, 20)
  );
};
