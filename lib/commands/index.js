...
function engineCall(commandOptions, _ref11) {
  var callee = _ref11.callee,
      input = _ref11.input;
  return command(commandOptions, _txHelper.default.addCommand(_txHelper.default.emptyTransaction(), 'engineCall', {
    callee: callee,
    input: input
  }));
}
...
function grantPermission(commandOptions, _ref12) {
  var accountId = _ref12.accountId,
      grantablePermissionName = _ref12.grantablePermissionName;
...
function removeSignatory(commandOptions, _ref13) {
  var accountId = _ref13.accountId,
      publicKey = _ref13.publicKey;
...
function revokePermission(commandOptions, _ref14) {
  var accountId = _ref14.accountId,
      grantablePermissionName = _ref14.grantablePermissionName;
...
function setAccountDetail(commandOptions, _ref15) {
...
function setAccountQuorum(commandOptions, _ref16) {
  var accountId = _ref16.accountId,
      quorum = _ref16.quorum;
...
function substractAssetQuantity(commandOptions, _ref17) {
  var assetId = _ref17.assetId,
...
function transferAsset(commandOptions, _ref18) {
  var srcAccountId = _ref18.srcAccountId,
      destAccountId = _ref18.destAccountId,
      assetId = _ref18.assetId,
