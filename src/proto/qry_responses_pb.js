...
proto.iroha.protocol.EngineResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    engineResponseRecordsList: jspb.Message.toObjectList(msg.getEngineResponseRecordsList(),
    primitive_pb.EngineResponseRecord.toObject, includeInstance)
  };
...
proto.iroha.protocol.EngineResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      primitive_pb.EngineResponseRecord.serializeBinaryToWriter
    );
  }
};
...
proto.iroha.protocol.EngineResponse.prototype.getEngineResponseRecordsList = function() {
  return /** @type{!Array<!proto.iroha.protocol.EngineResponseRecord>} */ (
...
proto.iroha.protocol.QueryResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      15,
      f,
      proto.iroha.protocol.EngineResponse.serializeBinaryToWriter
    );
  }
...
proto.iroha.protocol.QueryResponse.prototype.getEngineResponse = function() {
  return /** @type{?proto.iroha.protocol.EngineResponse} */ (
